                                                            ...
                                                            stack_t* operators)
{
    ...
    status = relations_LUT[stack_top][curr_input](curr_input, numbers, operators);
                                                            ...
                                                            stack_t* operators)
{
    ...
    operation_funcs_LUT[curr_input](numbers);
    StackPeek(operators, &curr_input);
    return relations_LUT[curr_input][input](input, numbers, operators);
}
...
status_t Calculate(const char* str, double* ans)
{
    ...
    status = status == SUCCESS ? finalize_state_LUT[state](ans, numbers_stack,
                                            operators_stack) : INVALID_SYNTAX;
    StackDestroy(numbers_stack);
